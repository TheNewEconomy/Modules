...
public class SimpleConomy extends Converter {
  private File configFile = new File(TNECore.directory(), "../SimpleConomy/config.yml");
  private YamlFile config = YamlFile.loadConfiguration(configFile, true);

  public SimpleConomy() {
    super("../SimpleConomy/config.yml");
  }
  ...
  public File dataFolder() {
    return new File(TNECore.directory(), "../SimpleConomy/config.yml");
  }
