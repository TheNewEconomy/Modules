...
public class FeConomy extends Converter {
  private File configFile = new File(TNECore.directory(), "../Fe/config.yml");
  ...
  public FeConomy() throws IOException {
  }
  ...
  public File dataFolder() {
    return new File(TNECore.directory(), "../Fe/config.yml");
  }
    ...
    try(Connection connection = db.getConnection();
      ...
      while(results.next()) {
        ConversionModule.convertedAdd(results.getString(nameColumn),
            ...
            BigDecimal.valueOf(results.getDouble(balanceColumn)));
      }
