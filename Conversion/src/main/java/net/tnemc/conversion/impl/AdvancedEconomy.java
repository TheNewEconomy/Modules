...
public class AdvancedEconomy extends Converter {
  private File configFile = new File(TNECore.directory(), "../AdvancedEconomy/config.yml");
  private YamlFile config = YamlFile.loadConfiguration(configFile, true);

  public AdvancedEconomy() throws IOException {
  }
  ...
  public File dataFolder() {
    return new File(TNECore.directory(), "../AdvancedEconomy/config.yml");
  }
