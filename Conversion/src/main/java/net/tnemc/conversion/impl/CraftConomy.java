...
public class CraftConomy extends Converter {
  private final File configFile = new File(TNECore.directory(), "../Craftconomy3/config.yml");
  ...
  public CraftConomy() throws IOException {
  }
  ...
  public File dataFolder() {
    return new File(TNECore.directory(), "../Craftconomy3/config.yml");
  }
  ...
  public void h2() throws InvalidDatabaseImport {
    initialize(new TNEDataManager(type(), config.getString("System.Database.Address"),
        config.getInt("System.Database.Port"), config.getString("System.Database.Db"),
        "sa", "",
        accTable, new File(TNECore.directory(), "../Craftconomy3/database.h2").getAbsolutePath(),
        false, false, 60, false));
